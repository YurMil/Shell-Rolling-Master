...
import type {
    ShellCadStepRequest,
    ShellCadWarmupRequest,
    ShellCadWorkerMessage,
    ShellCadWorkerProgress,
...
type PendingRequest = {
    ...
    onProgress?: (message: ShellCadWorkerProgress) => void;
};
...
const getWorker = () => {
    ...
    worker.addEventListener('message', (event: MessageEvent<ShellCadWorkerMessage>) => {
...
export const warmupCadWorker = async () => {
    ...
    await new Promise<ArrayBuffer>((resolve, reject) => {
        ...
        const request: ShellCadWarmupRequest = {
            type: 'warmup',
            requestId,
        };
...
export const generateStepInWorker = async (
    ...
    new Promise<ArrayBuffer>((resolve, reject) => {
        ...
        const request: ShellCadStepRequest = {
            type: 'generate-step',
            requestId,
            geometry,
        };
